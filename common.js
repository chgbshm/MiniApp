...
function Submit(url, data, success, fail, complete) {
	wx.showLoading({
		title: '请稍后',
		mask : true,
	});
 ...
 * @param success
 */
function get_openid(url, success) {
...
/**
 * 模块化方法
 * @type {{_post: *, Toast: *, GetLocation: *, Model: *, VerifyURL: *, checkmobile: *, _get: *, saveFormId: *, GetList: *, in_array: *}}
 */
module.exports = {
