// LAM 公共函数
// const web_url = 'http://lam.xq.com/'                             // 自定义请求URL
const web_url = 'https://f.xilukeji.com/xqcrm/public/'      // 自定义请求URL
// 腾讯地图key
/**
 * 获取定位并解析地址(腾讯地图)
...
function GetLocation(success) {
	let map_key = 'LKVBZ-BFD24-QECUW-DK6AS-FPY66-C4BEC'
	wx.getLocation({
		type: 'wgs84',
		success(res) {
			// console.log(res)
